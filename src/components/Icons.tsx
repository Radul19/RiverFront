...
export const IconEdit = ({ size = 24, color = "#191919" }) => {
  return (
    <Svg
      clipRule="evenodd"
      fillRule="evenodd"
...
export const IconTrash = ({size=24,color="#191919"})=>{
    return(
<Svg width={size} height={size} fill={color} clipRule="evenodd" fillRule="evenodd" strokeLinejoin="round" strokeMiterlimit="2" viewBox="0 0 24 24" ><Path d="m20.015 6.506h-16v14.423c0 .591.448 1.071 1 1.071h14c.552 0 1-.48 1-1.071 0-3.905 0-14.423 0-14.423zm-5.75 2.494c.414 0 .75.336.75.75v8.5c0 .414-.336.75-.75.75s-.75-.336-.75-.75v-8.5c0-.414.336-.75.75-.75zm-4.5 0c.414 0 .75.336.75.75v8.5c0 .414-.336.75-.75.75s-.75-.336-.75-.75v-8.5c0-.414.336-.75.75-.75zm-.75-5v-1c0-.535.474-1 1-1h4c.526 0 1 .465 1 1v1h5.254c.412 0 .746.335.746.747s-.334.747-.746.747h-16.507c-.413 0-.747-.335-.747-.747s.334-.747.747-.747zm4.5 0v-.5h-3v.5z" fillRule="nonzero"/></Svg>
    )
}


export const IconPhone = ({size=24,color="#191919"})=>{
    return(
<Svg width={size} height={size} fill={color} viewBox="0 0 24 24"><Path d="M20 22.621l-3.521-6.795c-.008.004-1.974.97-2.064 1.011-2.24 1.086-6.799-7.82-4.609-8.994l2.083-1.026-3.493-6.817-2.106 1.039c-7.202 3.755 4.233 25.982 11.6 22.615.121-.055 2.102-1.029 2.11-1.033z"/></Svg>
    )
}
export const IconSwitchOn = ({size=24,color="#191919"})=>{
    return(
<Svg width="32" height="24" viewBox="0 0 32 24" fill={color} >
<Path fillRule="evenodd" clipRule="evenodd" d="M8 20H24C28.4147 20 32 16.4147 32 12C32 7.58533 28.4147 4 24 4H7.948C3.55733 4.028 0 7.60133 0 12C0 16.4147 3.584 20 8 20ZM24 6.66667C21.056 6.66667 18.6667 9.056 18.6667 12C18.6667 14.944 21.056 17.3333 24 17.3333C26.944 17.3333 29.3333 14.944 29.3333 12C29.3333 9.056 26.944 6.66667 24 6.66667Z" />
</Svg>

    )
}
export const IconSwitchOff = ({size=24,color="#191919"})=>{
    return(
<Svg width="32" height="24" fill={color} viewBox="0 0 32 24"  >
<Path fillRule="evenodd" clipRule="evenodd" d="M24 20H8C3.58533 20 0 16.4147 0 12C0 7.58533 3.58533 4 8 4H24.052C28.4427 4.028 32 7.60133 32 12C32 16.4147 28.416 20 24 20ZM24 6.66667H8C5.056 6.66667 2.66667 9.056 2.66667 12C2.66667 14.944 5.056 17.3333 8 17.3333H24C26.944 17.3333 29.3333 14.944 29.3333 12C29.3333 9.068 26.9627 6.68533 24.0347 6.66667H24ZM8 8C10.208 8 12 9.792 12 12C12 14.208 10.208 16 8 16C5.792 16 4 14.208 4 12C4 9.792 5.792 8 8 8Z" />
</Svg>

    )
}
export const IconDelivery = ({size=24,color="#191919"})=>{
    return(
<Svg width={size} height={size} fill={color} fillRule="evenodd" clipRule="evenodd"><Path d="M5 11v1h8v-7h-10v-1c0-.552.448-1 1-1h10c.552 0 1 .448 1 1v2h4.667c1.117 0 1.6.576 1.936 1.107.594.94 1.536 2.432 2.109 3.378.188.312.288.67.288 1.035v4.48c0 1.089-.743 2-2 2h-1c0 1.656-1.344 3-3 3s-3-1.344-3-3h-4c0 1.656-1.344 3-3 3s-3-1.344-3-3h-1c-.552 0-1-.448-1-1v-6h-2v-2h7v2h-3zm3 5.8c.662 0 1.2.538 1.2 1.2 0 .662-.538 1.2-1.2 1.2-.662 0-1.2-.538-1.2-1.2 0-.662.538-1.2 1.2-1.2zm10 0c.662 0 1.2.538 1.2 1.2 0 .662-.538 1.2-1.2 1.2-.662 0-1.2-.538-1.2-1.2 0-.662.538-1.2 1.2-1.2zm-3-2.8h-10v2h.765c.549-.614 1.347-1 2.235-1 .888 0 1.686.386 2.235 1h5.53c.549-.614 1.347-1 2.235-1 .888 0 1.686.386 2.235 1h1.765v-4.575l-1.711-2.929c-.179-.307-.508-.496-.863-.496h-4.426v6zm1-5v3h5l-1.427-2.496c-.178-.312-.509-.504-.868-.504h-2.705zm-16-3h8v2h-8v-2z"/></Svg>
    )
}
export const IconOpen = ({size=24,color="#191919"})=>{
    return(
<Svg width={size} height={size} fill={color} viewBox="0 0 24 24"><Path d="M9.939 0l-.939 4.971v1.098c0 1.066-.933 1.931-2 1.931s-2-.865-2-1.932v-1.097l2.996-4.971h1.943zm-3.052 0l-2.887 4.971v1.098c0 1.066-.933 1.931-2 1.931s-2-.865-2-1.932v-1.097l4.874-4.971h2.013zm17.113 6.068c0 1.067-.934 1.932-2 1.932s-2-.933-2-2v-1.098l-2.887-4.902h2.014l4.873 4.971v1.097zm-10-1.168v1.098c0 1.066-.934 2.002-2 2.002-1.067 0-2-.933-2-2v-1.098l1.047-4.902h1.905l1.048 4.9zm2.004-4.9l2.994 5.002v1.098c0 1.067-.932 1.9-1.998 1.9s-2-.933-2-2v-1.098l-.939-4.902h1.943zm4.996 12v7h-18v-7h18zm2-2h-22v14h22v-14zm-14.953 4c-.871 0-1.415.654-1.415 1.513.001.841.542 1.487 1.415 1.487.865 0 1.416-.635 1.416-1.487 0-.85-.535-1.513-1.416-1.513zm0 2.319c-.446 0-.636-.37-.636-.806 0-.45.182-.828.636-.828s.637.376.637.828c0 .44-.192.806-.637.806zm3.031-2.256h-1.307v2.876h.779v-.963h.527c.658 0 1.023-.401 1.023-.956s-.364-.957-1.022-.957zm-.527.648h.365c.269 0 .426.058.426.309 0 .257-.167.309-.426.309h-.365v-.618zm2.604 1.543h1.449v.685h-2.228v-2.876h2.198v.686h-1.419v.387h1.303v.648h-1.303v.47zm4.212-2.191v2.876h-.737l-.979-1.576v1.576h-.742v-2.876h.734l.981 1.581v-1.581h.743z"/></Svg>
    )
}
